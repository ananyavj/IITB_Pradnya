...
2. The following reaction 4NH3(g) + 5O2(g) → 4NO(g) + 6H2O(g) is an example of a
...
6. A dilute ferrous sulphate solution was gradually added to the beaker containing acidified permanganate solution. The light purple colour of the solution fades and finally disappears.
...
2KClO3 (s) in the presence of Heat and Catalyst→ 2KCl (s) + 3O2 (g)
...
(i) 2KClO3 in the presence of Heat → 2KCl + 3O2 
(ii) MgO + H2O → Mg(OH)2 
(iii) 4Al + 3O2 → 2Al2O3 
...
(d) CaCO3 (s) in the presence of x  → CaO (s) + CO2 (g)
...
(d) Some bubbles of a gas are seen when zinc (Pb) is reacted with the acid.

Explain these observations giving suitable reasons.

32. A substance X, which is an oxide of a group 2 element, is used intensively in the cement industry. This element is present in bones also. On treatment with water it forms a solution which turns red litmus. Identify X and also write the chemical reactions involved.
...
(b) HgO (s) in the presence of Heat → Hg (l) + O2 (g) 
(c) Na (s) + S (s) Fuse to give → Na2S (s) 
(d) TiCl4 (l) + Mg (s) → Ti (s) + MgCl2 (s) 
(e) CaO (s) + SiO2 (s) → CaSiO3 (s) 
(f) H2O2 (l) in the presence of UV light → H2O (l) + O2 (g)
...
42. What happens when zinc granules are treated with dilute solution of H2SO4 , HCl, HNO3 , NaCl and NaOH, 
